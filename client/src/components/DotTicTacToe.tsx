    ...
    return (
      <div className="fixed bottom-8 right-8 z-50">
        <button 
          ...
          className="bg-black bg-opacity-30 text-white text-opacity-80 hover:text-opacity-100 px-5 py-3 rounded-md text-sm flex items-center transition-all duration-300 hover:bg-opacity-50 shadow-lg cursor-none"
        >
